...
export default function BuyersPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Image Section (like AboutPage split layout) */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-muted/30">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl font-bold text-foreground mb-6">Empowering Sustainable Businesses</h2>
            <p className="text-lg text-muted-foreground mb-6">
              By purchasing verified carbon credits, businesses across industries can demonstrate climate leadership,
              enhance ESG performance, and support coastal communities through blue carbon restoration.
            </p>
            <p className="text-lg text-muted-foreground">
              These credits are not just compliance tools but symbols of commitment towards a greener and more resilient
          ...
          <div className="relative">
            <img
              src="/img1.avif"
              alt="Businesses contributing to blue carbon projects"
      ...
      {/* Banner Image Section before CTA */}
      <section className="relative mb-16">
        <img
          src="/carbon-credits-marketplace.jpg"
          alt="Corporate leaders supporting blue carbon"
        ...
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center rounded-lg">
          <h2 className="text-3xl md:text-4xl font-bold text-white text-center px-4">
            Driving Climate Action Through Verified Carbon Markets
          </h2>
        </div>
      </section>
