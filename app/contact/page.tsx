...
import { Mail, Phone, MapPin, Clock, Users, ShoppingCart, HelpCircle, Send, CheckCircle } from "lucide-react"
      ...
      <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-muted-foreground text-pretty">
            Have questions about blue carbon restoration, carbon credits, or our platform? We're here to help you join India's transparent climate action initiative.
          </p>
        </div>
      </section>
              ...
              return (
                <Card key={index} className="text-center">
                  <CardContent className="p-6">
                    <div className={`w-12 h-12 bg-${info.color}/10 rounded-lg flex items-center justify-center mx-auto mb-4`}>
                  ...
                  {isSubmitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea id="message" rows={5} value={formData.message} onChange={(e) => handleInputChange("message", e.target.value)} placeholder="Please provide details about your inquiry..." required />
                      </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-primary/5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            The Blue Carbon Registry is an initiative of the Ministry of Earth Sciences, Government of India, in collaboration with the National Centre for Coastal Research (NCCR).
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card>
              <CardContent className="p-6 text-center">
                <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <img src="/ministry of earth science.png" alt="Ministry of Earth Sciences" className="w-16 h-16 object-cover rounded-full" />
                </div>
                <h3 className="text-xl font-semibold text-foreground mb-2">Ministry of Earth Sciences</h3>
                <p className="text-muted-foreground">Leading India's efforts in earth system science and climate research</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 text-center">
                <div className="w-16 h-16 bg-secondary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <img src="/nccr.jpg" alt="NCCR Verification" className="w-16 h-16 object-cover rounded-full" />
                </div>
